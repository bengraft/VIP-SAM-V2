---
title: "Geocode: Fill-in Missing with Zip or City Coordinates"
author: "Ben Graft"
date: "11/10/2020"
...
### Read in Geocoded Stores Dataframe
- fill in missing coordinates with that of the Zip Code or City the Store is within.
```{r}

```

Below is needs to be changed to do this for the new dataframe (geocoded_addresses.csv)
------

# geocode the stores with missing lat, long coordinates to the zip code's lat, long coordinates
```{r}
