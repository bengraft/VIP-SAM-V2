...
rm(df_brands_spirits, df_tdlinx_wide_spirits, df_brands_rtd, df_tdlinx_wide_rtd, 
   df_brands_wine, df_tdlinx_wide_wine, df_bind_spirits, df_bind_rtd, 
   df_bind_wine)
```
...
rm(df_gather_list, vipsam2_spirits, vipsam2_rtd, vipsam2_wine, vipsam2)
```
...
rm(TDlinx_master_spirits, TDlinx_master_rtd, TDlinx_master_wine, TDlinx_master)
```
